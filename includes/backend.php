...
function tcmb_doviz_kuru_admin_styles( $hook ) {
        ...
        wp_add_inline_style(
                ...
                . '.tcmb-doviz-kuru-admin .nav-tab { font-weight: 600; color: #1f2937; border-radius: 8px 8px 0 0; margin-right: 6px; background: #f8fafc; border-color: #e2e8f0; }'
                . '.tcmb-doviz-kuru-admin .nav-tab-active { background: #e0f2fe; border-color: #93c5fd; color: #0f172a; }'
                . '.tcmb-doviz-kuru-tab-content { display: grid; gap: 18px; margin-top: 18px; }'
                . '.tcmb-doviz-kuru-card { background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 18px 20px; box-shadow: 0 10px 24px rgba(15, 23, 42, 0.05); }'
                . '.tcmb-doviz-kuru-card h2, .tcmb-doviz-kuru-card h3 { margin-top: 0; }'
                . '.tcmb-doviz-kuru-card h2 { font-size: 1.25rem; color: #0f172a; }'
                . '.tcmb-doviz-kuru-card h3 { color: #0ea5e9; font-size: 1.05rem; font-weight: 700; margin-bottom: 10px; }'
                . '.tcmb-doviz-kuru-card p, .tcmb-doviz-kuru-card li, .tcmb-doviz-kuru-card label { font-size: 14px; line-height: 1.6; color: #334155; }'
                . '.tcmb-doviz-kuru-shortcode-list { list-style: none; padding-left: 0; margin: 10px 0 0; }'
                . '.tcmb-doviz-kuru-shortcode-item { border: 1px solid #e2e8f0; border-radius: 10px; padding: 10px 12px; margin-bottom: 8px; display: flex; flex-wrap: wrap; gap: 8px 12px; align-items: center; background: #f8fafc; }'
                . '.tcmb-doviz-kuru-shortcode-item code { font-size: 13px; background: #0f172a; color: #e0f2fe; padding: 3px 7px; border-radius: 8px; }'
                . '.tcmb-doviz-kuru-shortcode-label { font-weight: 700; color: #0f172a; display: inline-flex; align-items: center; gap: 8px; }'
                . '.tcmb-doviz-kuru-shortcode-chip { background: #e0f2fe; color: #0369a1; padding: 2px 8px; border-radius: 8px; font-size: 12px; font-weight: 700; }'
                . '.tcmb-doviz-kuru-shortcode-preview { color: #065f46; font-weight: 700; display: inline-flex; align-items: center; gap: 6px; background: #ecfdf3; border: 1px solid #bbf7d0; border-radius: 8px; padding: 4px 8px; }'
        ...
        <div class="tcmb-doviz-kuru-card">
                ...
                <ul class="tcmb-doviz-kuru-shortcode-list">
                        ...
                        <li class="tcmb-doviz-kuru-shortcode-item">
                                ...
                                <span class="tcmb-doviz-kuru-shortcode-preview">→ USD 27,8543 · EUR 29,4512 · GBP 34,1022</span>
                        </li>
                </ul>
